import { useSidebarColors, getInputStyle } from "./SidebarTokens";
...
const AccountModal = ({
  ...
  return (
    ...
    >
      <div style={{ fontFamily: "'Courier New', monospace", fontSize: "0.65rem", fontWeight: 900, letterSpacing: "3px", color: C.yellow }}>
        GANTI PASSWORD
      </div>
      ...
      <div style={{ width: "100%", maxWidth: "280px", display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        ...
        {formError && (
          <div style={{ fontSize: "0.6rem", color: "#ff6b6b", fontFamily: "'Courier New', monospace", letterSpacing: "1px" }}>
            {formError}
          </div>
        )}
        {formSuccess && (
          <div style={{ fontSize: "0.6rem", color: C.cyan, fontFamily: "'Courier New', monospace", letterSpacing: "1px" }}>
            {formSuccess}
          </div>
        )}
      </div>
      ...
      <div style={{ display: "flex", gap: "0.75rem" }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!formLoading) e.currentTarget.style.background = "rgba(255,230,0,0.08)";
          }}
          onMouseLeave={(e) => {
